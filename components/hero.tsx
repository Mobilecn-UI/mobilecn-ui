  ...
  return (
    <section className="flex flex-col gap-6 xl:gap-10 items-center py-4 md:py-11">
      <div className="flex flex-col gap-2 md:gap-4">
        <h1 className=" animate-text font-bold leading-tight text-5xl md:text-6xl xl:text-8xl md:p-1 text-center tracking-tighter bg-clip-text  text-transparent bg-gradient-to-br from-80% md:from-40% from-gray-300 to-gray-800">
      ...
      <div>
        <div className="flex flex-col md:flex-row gap-4">
          ...
          <Link
            ...
            rel="noopener noreferrer"
            className="bg-white flex gap-2 items-center justify-center h-16 w-56 rounded-2xl shadow-2xl transition-all hover:bg-gray-300"
            href="https://docs.swiftcn.lol/introduction"
          >
