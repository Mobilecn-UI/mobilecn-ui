  ...
  return (
    <section className="flex flex-col gap-6 xl:gap-10 items-center py-4 md:py-11">
      <div className="flex flex-col gap-2 md:gap-4">
        <h1 className="font-bold leading-tight text-5xl md:text-6xl xl:text-8xl md:p-1 text-center tracking-tighter bg-clip-text text-transparent bg-gradient-to-br from-60% md:from-40% from-white to-black">
          Gorgeous mobile UI components
        </h1>
        <h2 className="flex flex-col px-5 sm:px-12 text-gray-400 text-base sm:text-xl">
          <span>
